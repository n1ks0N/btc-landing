...
function initFeatures(settings) {
    ...
    if (!!settings.wheel && settings.wheel.isNeeded) {
        ...
        var wheelBlocks = {
            ...
            'en': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Attention!</b><br>You have an exclusive opportunity to get free ' + settings.product + '! Just launch the fortune wheel by pressing the "SPIN" button, and wait for it to stop. Who knows, maybe it is you that lucky guy, who will get the a lot of bitcoins today! Good Luck! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Congratulations!</span> </div> </div>',
        ...
        $('.cursor-text').click(function () {
            // $('.order_form').append($('.form-sub')) // вставляет поля с макросами в форму
